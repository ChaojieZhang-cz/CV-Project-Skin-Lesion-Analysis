...
u_net.load_state_dict(torch.load(path,map_location='cpu'))
...
class MyModel(nn.Module):
    ...
    def forward(self, x, data):
        ...
        x = self.fc(x)
        return x
u_net_trained = MyModel()
path = '/scratch/cz2064/myjupyter/Computer Vision/Project/Jupyter Notebook/py files/UNet-classifier/checkpoint_UNet_classifier.pt'
u_net_trained.load_state_dict(torch.load(path,map_location='cpu')['best_model_wts'])
...
class UNet_pretrained(nn.Module):
    def __init__(self):
        ...
        self.inc = u_net_trained.inc
        self.down1 = u_net_trained.down1
        self.down2 = u_net_trained.down2
        self.down3 = u_net_trained.down3
        self.down4 = u_net_trained.down4
        
        self.up1 = u_net.up1
        self.up2 = u_net.up2
        self.up3 = u_net.up3
        self.up4 = u_net.up4
        self.outc = u_net.outc
...
def train(model, train_loader=train_loader, val_loader=val_loader,num_epoch=1000,\
